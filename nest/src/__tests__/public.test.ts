...
import { getApp, getHttpServer } from './helpers/testApp';
...
describe("GET /api/public/:username", () => {
  it("returns a public user profile", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/publicuser");
  ...
  it("includes all expected fields in the response", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/fieldtest");
  ...
  it("never returns a password field", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/pwuser");
  ...
  it("returns 404 for an unknown username", async () => {
    const res = await request(getHttpServer()).get("/api/public/nosuchuser");
  ...
  it("does not require authentication", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/noauth");
...
describe("GET /api/public/:username/links", () => {
  it("returns public active links for a user", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/linkowner/links");
  ...
  it("excludes private links", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/privowner/links");
  ...
  it("excludes inactive links", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/inactowner/links");
  ...
  it("excludes both private and inactive links simultaneously", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/mixed/links");
  ...
  it("returns an empty array when user has no public active links", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/emptylinks/links");
  ...
  it("never returns password fields in any link", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/pwlinks/links");
  ...
  it("returns 404 when the user does not exist", async () => {
    const res = await request(getHttpServer()).get("/api/public/nosuchuser/links");
  ...
  it("does not return links belonging to a different user", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/user1pub/links");
  ...
  it("does not require authentication", async () => {
    ...
    const res = await request(getHttpServer()).get("/api/public/noauthlinks/links");
